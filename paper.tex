...
Mannheim Centre for European Social Research}
  ...
  \postdate{\par}
    \date{14 December, 2018\\[2\baselineskip]Feedback?\\
\href{mailto:mail@paulcbauer.eu}{\nolinkurl{mail@paulcbauer.eu}}\\}
...
Figure \ref{fig:fig-3}. Potentially, in case you did not install the
command line application this part may fail. If so simply exclude the
chunk and the latex code.
...
\item
  ...
  \item
    ...
    \item
      ...
      probably be understood by another researcher.
    \end{itemize}
  \item
